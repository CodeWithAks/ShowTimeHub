...
const Navbar = () => {
  return (
    <div>
       <div className="bg-gradient-to-r from-zinc-900 to-teal-900 text-white px-6 py-4 flex items-center justify-between">
       {/* <div className='bg-zinc-900 text-white px-6 py-4 flex items-center justify-between'> */}
        ...
        <div className="nav-brand text-2xl font-bold">
          <Link to="/" className="hover:text-teal-200 transition-colors duration-200 ml-10">
            🎬 ShowTimeHub
          </Link>
        </div>
        ...
        <div className="nav-links space-x-10 text-lg">
          ...
          <Link to="/favourites" className="hover:text-teal-400 transition-colors duration-200 mr-20">Favourites</Link>
        </div>
